...
def predict_img():
    if request.method=="POST":
        ...
        img="C:\\Users\\NIHARIKA\\Downloads\\human_detection (2)\\human_detection\\static\\uploads\\"+secure_filename(f.filename)
...
def predict_video():
    if request.method=="POST":
        ...
        video_path="C:\\Users\\NIHARIKA\\Downloads\\human_detection (2)\\human_detection\\static\\uploads\\"+secure_filename(f.filename)
